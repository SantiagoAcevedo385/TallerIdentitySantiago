...
namespace TallerIndentity.Controllers
{
    public class UsuariosController : Controller
    {
        private readonly TallerIdentityContext _context;

        public UsuariosController(TallerIdentityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Usuarios != null ? 
                          ...
                          Problem("Entity set 'TallerIdentityContext.Usuarios'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TallerIdentityContext.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
